    ...
    <div class="card step-1">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <span
                v-if="
                                          val_errors && val_errors.programme
                                      "
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              >
                ...
                <option :value="post.id" v-for="post in filteredPost">{{post.name_of_post}}</option>
              </select>
              <span>{{ errors.post }}</span>

              <span
                v-if="
                                          val_errors && val_errors.post
                                      "
      ...
      <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="father_name">Father's Name<span class="star">*</span></label>
                <input type="text" class="form-control" id="" placeholder="" v-model="father_name" :class="{
                                              border:
                ...
                <span v-if="val_errors && val_errors.father_name">x {{ val_errors.father_name[0] }}</span>

              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="mother_name">Mother's Name<span class="star">*</span></label>
                <input type="text" class="form-control" id="" placeholder="" v-model="mother_name"
                :class="{
                                              border:
                ...
                <span v-if="val_errors && val_errors.mother_name">x {{ val_errors.mother_name[0] }}</span>

              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="employment_reg_no">Employment Exchange Registration No<span class="star">*</span></label>
                <input type="text" class="form-control" id="" placeholder="" v-model="employment_reg_no"
                :class="{
                                              border:
                                                  spanError.employment_reg_no == true ||
                                                  (val_errors &&
                                                      val_errors.employment_reg_no != null)
                                          }"
                >
                <span>{{ errors.employment_reg_no }}</span>
                <span v-if="val_errors && val_errors.employment_reg_no">x {{ val_errors.employment_reg_no[0] }}</span>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
      ...
      <div class="card-body">
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label for="village_town">Address<span class="star">*</span></label>
                ...
                <span v-if="val_errors && val_errors.village_town">x {{ val_errors.village_town[0] }}</span>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="post_office">Post Office<span class="star">*</span></label>
                ...
                <span v-if="val_errors && val_errors.post_office">x {{ val_errors.post_office[0] }}</span>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="police_station">Police Station<span class="star">*</span></label>
                <input type="text" class="form-control" id="" placeholder="" v-model="police_station"
                :class="{
                                              border:
                                                  spanError.police_station == true ||
                                                  (val_errors &&
                                                      val_errors.police_station != null)
                                          }"
                >
                <span>{{ errors.police_station }}</span>
                <span v-if="val_errors && val_errors.police_station">x {{ val_errors.police_station[0] }}</span>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="pincode">Pin Code<span class="star">*</span></label>
                <input type="number" class="form-control" id="" placeholder="" v-model="pincode"
                :class="{
                                              border:
                ...
                <span v-if="val_errors && val_errors.pincode">x {{ val_errors.pincode[0] }}</span>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <span v-if="val_errors && val_errors.district">x {{ val_errors.district[0] }}</span>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <span v-if="val_errors && val_errors.state">x {{ val_errors.state[0] }}</span>
              </div>
            </div>
          </div>
      </div>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              <label for="c_village_town">Address<span class="star">*</span></label>
              <input type="text" class="form-control" id="" placeholder="" v-model="c_village_town"
              :class="{
                                            border:
                                                spanError.c_village_town == true ||
                                                (val_errors &&
                                                    val_errors.c_village_town != null)
                                        }"
              >
              <span>{{ errors.c_village_town }}</span>
              <span v-if="val_errors && val_errors.c_village_town">x {{ val_errors.c_village_town[0] }}</span>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              <label for="c_post_office">Post Office<span class="star">*</span></label>
              <input type="text" class="form-control" id="" placeholder="" v-model="c_post_office"
              :class="{
                                            border:
                                                spanError.c_post_office == true ||
                                                (val_errors &&
                                                    val_errors.c_post_office != null)
                                        }"
              >
              <span>{{ errors.c_post_office }}</span>
              <span v-if="val_errors && val_errors.c_post_office">x {{ val_errors.c_post_office[0] }}</span>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              <label for="c_police_station">Police Station<span class="star">*</span></label>
              <input type="text" class="form-control" id="" placeholder="" v-model="c_police_station"
              :class="{
                                            border:
                                                spanError.c_police_station == true ||
                                                (val_errors &&
                                                    val_errors.c_police_station != null)
                                        }"
              >
              <span>{{ errors.c_police_station }}</span>
              <span v-if="val_errors && val_errors.c_police_station">x {{ val_errors.c_police_station[0] }}</span>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              <label for="c_pincode">Pin Code<span class="star">*</span></label>
              <input type="number" class="form-control" id="" placeholder="" v-model="c_pincode"
              :class="{
                                            border:
              ...
              <span v-if="val_errors && val_errors.c_pincode">x {{ val_errors.c_pincode[0] }}</span>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              <label for="c_district">District<span class="star">*</span></label>
              <select class="form-control" v-model="c_district"
              :class="{
                                            border:
              ...
              <span v-if="val_errors && val_errors.c_district">x {{ val_errors.c_district[0] }}</span>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              <label for="c_state">State<span class="star">*</span></label>
              <select class="form-control" v-model="c_state"
              :class="{
                                            border:
              ...
              <span v-if="val_errors && val_errors.c_state">x {{ val_errors.c_state[0] }}</span>
            </div>
          </div>
        </div>
      </div>
...
export default{
    ...
    methods:{
      ...
      onNext(){
        ...
        if (this.existing_employee == "Yes" && !this.existing_emp_year.toString().length) {
        ...
        if (Object.keys(this.errors).length == 0) {
          ...
          this.$store.dispatch('personalInformationSave',formData)
          .then((result) => {
                  this.$store.state.personal_information_errors=null;
                  // this.$store.dispatch('changeStep', {next:1, prev:0});
    ...
    created(){
      ...
      this.$store.dispatch('getPersonalInfo').then(()=>{
        this.programme=this.$store.state.personalInfo.programme,
        this.post=this.$store.state.personalInfo.post,
        this.dob=this.$store.state.personalInfo.dob,
        this.gender=this.$store.state.personalInfo.gender,
        this.religion=this.$store.state.personalInfo.religion,
        ...
        this.existing_employee= this.$store.state.personalInfo.existing_employee,
        this.existing_emp_year= this.$store.state.personalInfo.existing_emp_year,
        this.ews= this.$store.state.personalInfo.ews,
        this.ex_serviceman= this.$store.state.personalInfo.ex_serviceman,
        ...
        this.district=this.$store.state.personalInfo.district
        ...
        this.c_district=this.$store.state.personalInfo.c_district
    ...
    mounted(){
      ...
      // console.log('infos',this.personalInfo);
    }
  }
</script>
