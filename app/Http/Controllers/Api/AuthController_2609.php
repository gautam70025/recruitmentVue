        ...
        if($user){
             try {
              ...
              //  send otp
               ...
               $message='Registration No:'.$mail_data->registration_no.'\n Password:'.$mail_data->password;
               $link="http://pnrdassam.org/assam/samparka/sendit_otp/".$phone_no.'/'.$message;
              curl_setopt($ch, CURLOPT_URL, $link);
              // curl_setopt($ch, CURLOPT_URL, "http://pnrdassam.org/assam/samparka/sendit_otp/8876145383/Welcome%20to%20the%20Test");
